...
in
{
  options.features.desktop.firefox.enable = mkEnableOption "install firefox and its addons";
        ...
        policies = {
          ...
          ExtensionSettings = {
            ...
            "{446900e4-71c2-419f-a6a7-df9c091e268b}" = {
              install_url = "https://addons.mozilla.org/firefox/downloads/file/4355865/bitwarden_password_manager-2024.9.1.xpi";
              installation_mode = "force_installed";
            };
